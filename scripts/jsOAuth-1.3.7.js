...
exports.OAuth = (function (global) {
    ...
    OAuth.prototype = {
        ...
        init: function (options) {
             ...
             *      defaultoauth {boolean} true is normal oauth, false is croudia etc easy oauth
             */
            this.request = function (options) {
                ...
                var defaultoauth = "use";
                if (options.defaultoauth) defaultoauth = options.defaultoauth;
                console.log("defaultoauth=");
                console.log(defaultoauth);
